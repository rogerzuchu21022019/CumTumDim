...
import styles from './StyleManageCategories';
      ...
      <View style={styles.container}>
        ...
        <View style={styles.body}>
          <View style={styles.groupBody}>
            {/* Thêm loại món ăn */}
            <TouchableOpacity
              onPress={() => moveToScreen(Router.ADD_TYPE_FOOD)}>
            ...
            {/* Sửa loại món ăn */}
            <TouchableOpacity
              onPress={() => moveToScreen(Router.EDIT_TYPE_FOOD)}>
              <View style={styles.btnAll}>
                <Image
                  source={require('../../../../../../assets/iconLogo_CumTumDim.jpg')}
                />
            ...
            {/* xóa loại món ăn */}
            <TouchableOpacity
              onPress={() => moveToScreen(Router.DELETE_TYPE_FOOD)}>
              <View style={styles.btnAll}>
                <Image
                  source={require('../../../../../../assets/iconLogo_CumTumDim.jpg')}
                />
